...
class SomeInternalClass1 {}              // 隐式访问级别 internal
var someInternalConstant1 = 0            // 隐式访问级别 internal
...
public class SomePublicClass1 {          // 显式的 public 类
...
private class SomePrivateClass1 {        // 显式的 private 类
...
//因为父类C和子类D定义在同一个源文件中，所以在类D中可以在重写的someMethod方法中调用super.someMethod()。
